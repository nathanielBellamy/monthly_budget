*MonthlyBudget is a simple utility for intaking budgetary CSVs, manipulating and analyzing data, and writing the results to new CSVs of differing formats.
*
*
*
*
